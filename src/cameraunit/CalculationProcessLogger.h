...
private:
    ...
    unsigned long long t_process_of_send_disparity, t_start_of_send_disparity, t_end_of_send_disparity;
...
public:
    ...
    void send_disparity( CalculationProcessLogger::Event evt );
